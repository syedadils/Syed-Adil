      ...
      {({ open }) => (
        <>
          <div className=" max-w-full px-2 sm:px-6 lg:px-8">
            <div className="relative justify-end flex h-16 items-center ">
              ...
              <div className="flex   items-center  sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div
                    ...
                    className="flex space-x-4 text-white font-semibold m-10  "
                  >
                    {navigation.map((item) => (
                      <Link
                        smooth={true}
                        ...
                        className={classNames(
                          ...
                          "rounded-md px-3 py-2 text-sm font-medium bg-gray-900"
                        )}
